...
### Importar Paquetes.
Para comenzar, verificamos que estén instalados los paquetes necesarios.
...
Cargamos las  librerías de los paquetes ya instalados llamandolas mediante la función library().
...
Recordar, revisar si la ruta y la fecha en el nombre de archivo requieren actualización.
```{r}
mobility_url <- "https://covid19-static.cdn-apple.com/covid19-mobility-data/2107HotfixDev9/v3/en-us/"

aux <-  paste(mobility_url, "applemobilitytrends-2021-05-04.csv", sep = "")
